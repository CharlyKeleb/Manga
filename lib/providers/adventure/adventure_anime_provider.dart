...
class AdventureAnimeProvider with ChangeNotifier {
  ...
  Future<void> fetchAndRomanceManga(
      ...
      [int limit = 10]) async {
    final url =
        "https://kitsu.io/api/edge/anime?filter[categories]=adventure&page[limit]=$limit&page[offset]=$offset&sort=popularityRank";
