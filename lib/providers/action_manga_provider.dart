...
class ActionMangaProvider with ChangeNotifier {
  ...
  Future<void> fetchAndActionManga(
      int offset,
      [int limit = 10]) async {
    final url =
        "https://kitsu.io/api/edge/manga?filter[categories]=action&page[limit]=$limit&page[offset]=$offset&sort=popularityRank";
